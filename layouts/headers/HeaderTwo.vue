          ...
          <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-4 col-6">
              <div class="logo text-end">
                <NuxtLink to="/">
                  <img
                    src="~/assets/img/iconwebtechnopark/logo.png"
                    style="width: 90%"
                    alt=""
                  />
                </NuxtLink>
            ...
            <div class="col-xxl-5 col-xl-5 col-lg-3 d-none d-lg-block mt-20">
            ...
            <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8 col-6">
              <div
                class="header__top-right-4 d-flex align-items-center justify-content-end"
              >
                <div
                  class="header__info-wrapper-4 d-flex align-items-center justify-content-end"
                >
                  <div
                    class="header__info-item d-none d-lg-flex align-items-center"
                  >
